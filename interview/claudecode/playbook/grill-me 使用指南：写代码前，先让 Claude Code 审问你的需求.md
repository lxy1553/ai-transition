...
url: http://xiaolinnote.com/claudecode/playbook/grill_me.html
scraped: 2026-07-23T11:39:07.071037
---

# grill-me 使用指南：写代码前，先让 Claude Code 审问你的需求

> 原文链接: http://xiaolinnote.com/claudecode/playbook/grill_me.html

# grill-me 使用指南：写代码前，先让 Claude Code 审问你的需求

原创公众号@小林coding图解Claude Code大约 10 分钟约 2854 字

---

# [grill-me 使用指南：写代码前，先让 Claude Code 审问你的需求](#grill-me-使用指南-写代码前-先让-claude-code-审问你的需求)

大家好，我是小林。

之前写「[SDD 规范](https://mp.weixin.qq.com/s/gROJvKs_47BCOZx3KLYbTA)」那篇，评论区有读者提到一个叫 `grill-me` 的 skill。

![](https://cdn.xiaolincoding.com//picgo/image-20260703215201681.png)
...
![](https://cdn.xiaolincoding.com//picgo/4c6f9839_grilling-three-rules-annotated.png)
...
![](https://cdn.xiaolincoding.com//picgo/image-20260703133741149.png)

跑完在列表里勾上 `grill-me` 就装好了。之后在 Claude Code 里敲 `/grill-me` 就能显示出来了。

![](https://cdn.xiaolincoding.com//picgo/image-20260703135425312.png)

我的念头很朴素，就这么一句，一字没多写，丢给它。

> 作为一个天天要找选题的 AI 自媒体人，我想做个小助手，每天自动帮我扒各个平台的热点，整理成一份选题清单发给我。

![](https://cdn.xiaolincoding.com//picgo/image-20260703135604786.png)
...
![](https://cdn.xiaolincoding.com//picgo/image-20260703163651744.png)
...
![](https://cdn.xiaolincoding.com//picgo/image-20260703163738697.png)

我回：AI 编程实践、大模型动态、Claude Code 这些。

![](https://cdn.xiaolincoding.com//picgo/image-20260703163815977.png)

它拿着这个答案往下推了一层：既然是 AI 编程，那热点几乎都在英文源首发，X、HackerNews、GitHub 才是主战场，国内平台对这个垂类基本是慢半拍的二手翻译。

![](https://cdn.xiaolincoding.com//picgo/image-20260703163858558.png)

注意这个顺序。它问「扒哪些平台」的时候，答案早被我上一轮「写 AI 编程」框住了。上游先定，下游才有方向。这就是那棵设计树，一根枝丫喂着下一根。

后面它一轮轮往下问，一共问了我 10+ 轮，一天几条、推到哪、几点推这些就不细说了。

![](https://cdn.xiaolincoding.com//picgo/image-20260703171239598.png)

中间有一问我印象最深，它揪出个我自己绝想不到的坑：这助手每天独立起跑、不记得昨天推过啥，那一个热点连挂三天，会不会连推我三天同一个选题。这种事等真发生了才反应过来就晚了，它在写代码前就替我想到了。

![](https://cdn.xiaolincoding.com//picgo/image-20260703170152305.png)

到了第九轮，终于开始跑第一版了。

![](https://cdn.xiaolincoding.com//picgo/91a532891a9d24cb27916d3140d8b1b7.png)

手动跑出来的效果如下，把 AI 圈里值得写的内容梳理了一份给我。

![](https://cdn.xiaolincoding.com//picgo/abef15b0cdba02d7221cca0158546211.png)

它还跟我确认是不是这个味，我觉得没问题，就开始后续的飞书连通性测试和定时任务设置。

![](https://cdn.xiaolincoding.com//picgo/image-20260703171636000.png)

最终的效果，它每天定时去扒 AI 圈值得写的选题，筛选之后推送到我的飞书。

![](https://cdn.xiaolincoding.com//picgo/image-20260703165427959.png)
...
![](https://cdn.xiaolincoding.com//picgo/362ef27b_plan-mode-vs-grill-me.png)
