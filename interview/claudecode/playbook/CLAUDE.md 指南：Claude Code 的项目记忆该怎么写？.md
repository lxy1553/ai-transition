...
url: http://xiaolinnote.com/claudecode/playbook/cc_claude_md.html
scraped: 2026-07-23T11:39:03.949209
---

# CLAUDE.md 指南：Claude Code 的项目记忆该怎么写？

> 原文链接: http://xiaolinnote.com/claudecode/playbook/cc_claude_md.html

# CLAUDE.md 指南：Claude Code 的项目记忆该怎么写？

原创公众号@小林coding图解Claude Code大约 21 分钟约 6261 字

---

# [[CLAUDE.md](http://CLAUDE.md) 指南：Claude Code 的项目记忆该怎么写？](#claude-md-指南-claude-code-的项目记忆该怎么写)
...
![](https://cdn.xiaolincoding.com//picgo/03-rule-dialog-demo-d91a6d7c.png)
...
![](https://cdn.xiaolincoding.com//picgo/04-readme-vs-claude-md-f13b5cb0.png)
...
![](https://cdn.xiaolincoding.com//picgo/05-directory-climb-search-c254ff7c.png)

到这里你应该能感觉到 [CLAUDE.md](http://CLAUDE.md) 的特殊之处了：**它不是文档，是配置**。是你给 Claude 配的「这个项目的预设」。

![](https://cdn.xiaolincoding.com//picgo/06-config-vs-document-eb07bc2f.png)
...
![](https://cdn.xiaolincoding.com//picgo/image-20260519220230560.png)
...
![](https://cdn.xiaolincoding.com//picgo/08-attention-dilution-4c6b7d2f.png)
...
![](https://cdn.xiaolincoding.com//picgo/09-three-anti-patterns-19c81215.png)
...
![](https://cdn.xiaolincoding.com//picgo/10-verifiable-rule-a-vs-b-d2a0d0ab.png)
...
![](https://cdn.xiaolincoding.com//picgo/11-vague-to-specific-translator-2408f058.png)
...
![](https://cdn.xiaolincoding.com//picgo/12-why-boundary-judgment-e2312738.png)
...
![](https://cdn.xiaolincoding.com//picgo/13-living-document-pruning-113614fe.png)
...
![](https://cdn.xiaolincoding.com//picgo/15-three-layer-drawers-d582026e.png)
...
![](https://cdn.xiaolincoding.com//picgo/16-path-scoped-loading-8afceb34.png)

打个比方，公司有总公司手册、各部门有部门手册、每个岗位有岗位手册。你不会让每个新人都把所有手册随身带着，对应业务的时候才翻对应的手册。

这种模块化拆分的好处就是上一节那个 96% 数据：少加载、按需加载，效果反而比一坨更好。

![](https://cdn.xiaolincoding.com//picgo/17-modular-vs-single-file-41dbb89f.png)
...
![](https://cdn.xiaolincoding.com//picgo/image-20260519220747776.png)
...
![](https://cdn.xiaolincoding.com//picgo/image-20260519230912791.png)
...
![](https://cdn.xiaolincoding.com//picgo/18-agents-single-source-b14104a8.png)
...
![](https://cdn.xiaolincoding.com//picgo/19-conflicting-rules-ring-888b50f4.png)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/ysyAxM1rgX1zn8AeTP545e6nfO4EmHRkvJprO1SYLRcn6LoZwrBjibFryrczP8ejdwGiaxdRfKic7N4wVyWDL8XbwU6I2nibCOEibP8J2iaXxUL1M/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=37)

我实测过，`/init` 起的草稿质量出乎意料地好。当然不完美，你得 review 一遍删掉不准的、补上漏掉的，但起点已经比从空文件开始高出几个台阶。

![](https://cdn.xiaolincoding.com//picgo/20-init-workflow-6628140f.png)

项目跑起来之后，规则怎么补充？最经典的工作流是这样：**Claude 在哪儿犯错了，就加一条防御规则。**

但你不需要手动打开 [CLAUDE.md](http://CLAUDE.md) 编辑，Claude Code 提供了 `/memory` 命令。

![](https://mmbiz.qpic.cn/mmbiz_png/ysyAxM1rgX3Hh3Q3mN8y7ksKUDQ8D0KQKiaVE5x0Xp7Giayrtqze9JFGgZwT4uKcEwS7VxJYGln8YT9l2Zg703g2y8YIqH1luVZ6O2nZxknEs/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=29)
...
![](https://cdn.xiaolincoding.com//picgo/21-memory-command-62230d7b.png)

[claudeguide.io](http://claudeguide.io) 给了一个特别实用的规则触发标准：**Claude 错两次以上，就加一条新规则。** 一次可能是偶发，两次说明规则有缺。再不写就会一直被它坑。

![](https://cdn.xiaolincoding.com//picgo/22-maintenance-loop-4c60145c.png)

还有一个常被忽略的命令配合：**Plan Mode**。

复杂任务的时候，按 Shift+Tab 两次切到 Plan Mode，Claude 不直接动手写代码，而是先出一份计划给你看，确认了再执行。

![](https://mmbiz.qpic.cn/mmbiz_png/ysyAxM1rgX0G4Ek54xTwZXdBgkdekpSrF3adGeSGd6u6pZZQLYM6SlJX5ox9OOe0qcS8f0L2kEaj8oNWpVrSqQ6IqUdP40tN94TgPrwWHGY/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=16)
...
![](https://cdn.xiaolincoding.com//picgo/23-plan-mode-workflow-3b9d0fc5.png)
...
![](https://cdn.xiaolincoding.com//picgo/24-six-section-template-81d6bb5b.png)
...
![](https://cdn.xiaolincoding.com//picgo/25-template-skeleton-to-content-17a3f1f9.png)
...
![](https://cdn.xiaolincoding.com//picgo/26-three-sentence-summary-card-05795db9.png)
