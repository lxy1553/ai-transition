...
url: http://xiaolinnote.com/claudecode/playbook/spec_driven_dev.html
scraped: 2026-07-23T11:39:06.333627
---

# SDD 规约驱动开发实战：在 Claude Code 里跑通先规约后编码

> 原文链接: http://xiaolinnote.com/claudecode/playbook/spec_driven_dev.html

# SDD 规约驱动开发实战：在 Claude Code 里跑通先规约后编码

原创公众号@小林coding图解Claude Code大约 20 分钟约 6065 字

---

# [SDD 规约驱动开发实战：在 Claude Code 里跑通先规约后编码](#sdd-规约驱动开发实战-在-claude-code-里跑通先规约后编码)
...
![](https://cdn.xiaolincoding.com//picgo/85bb80f4_ai-rework-tug-of-war.png)
...
![](https://cdn.xiaolincoding.com//picgo/26683267_vibe-coding-small-project.png)
...
![](https://cdn.xiaolincoding.com//picgo/ae190d8d_fragmented-requirements-misfire.png)
...
![](https://cdn.xiaolincoding.com//picgo/a161f45c_missing-shared-spec.png)
...
![](https://cdn.xiaolincoding.com//picgo/94a979ff_implicit-to-explicit-spec.png)
...
![](https://cdn.xiaolincoding.com//picgo/bd58e919_spec-driven-four-steps.png)
...
![](https://cdn.xiaolincoding.com//picgo/9d1fee8e_early-bug-cost-curve.png)
...
![](https://cdn.xiaolincoding.com//picgo/image-20260703004834877.png)
...
![](https://cdn.xiaolincoding.com//picgo/8d8342ad_project-constitution.png)
...
![](https://cdn.xiaolincoding.com//picgo/0cf8dcf7_speckit-specify-output.png)
...
![](https://cdn.xiaolincoding.com//picgo/0305e20a_speckit-plan-output.png)
...
![](https://cdn.xiaolincoding.com//picgo/13bc56d5_speckit-tasks-breakdown.png)
...
![](https://cdn.xiaolincoding.com//picgo/43accd1f_speckit-command-pipeline.png)
...
![](https://cdn.xiaolincoding.com//picgo/image-20260702222526772.png)

上面这里我就直接选择了 `sh`。

![](https://cdn.xiaolincoding.com//picgo/image-20260702222643679.png)
...
![](https://cdn.xiaolincoding.com//picgo/image-20260702225100720.png)

进到 Claude Code 之后，敲一个斜杠，就能看到 speckit 那一串 skill 蹦出来了，`/speckit-specify`、`/speckit-plan`、`/speckit-tasks` 一排列在那，随手可用。

![](https://cdn.xiaolincoding.com//picgo/image-20260702225219063.png)
...
![](https://cdn.xiaolincoding.com//picgo/image-20260702225333944.png)
...
![](https://cdn.xiaolincoding.com//picgo/image-20260702225815628.png)

你打开`specs/001-team-kanban/spec.md`这份文档，你会发现这是非常详细的需求文档了，所以你一定要停下来读一遍，这是整个流程里性价比最高的一次检查。你现在花两分钟看一眼它有没有理解错，能省掉后面两小时的返工。

![](https://cdn.xiaolincoding.com//picgo/image-20260702235432107.png)
...
![](https://cdn.xiaolincoding.com//picgo/image-20260702235747708.png)

这回轮到技术了。Claude Code 会基于刚才那份需求文档，产出一份技术方案。

![](https://cdn.xiaolincoding.com//picgo/image-20260703000129843.png)

包括大概分几个模块、接口怎么设计、数据表长什么样。这份你同样过一遍，不认同的地方直接改。

![](https://cdn.xiaolincoding.com//picgo/image-20260703000153790.png)
...
![](https://cdn.xiaolincoding.com//picgo/image-20260703000731454.png)
...
![](https://cdn.xiaolincoding.com//picgo/20260703001754_rec_.gif)

猛猛干了 10分钟之后，前端和后端都开发完了。

![](https://cdn.xiaolincoding.com//picgo/image-20260703002038276.png)

开发完之后，我们来运行项目看看效果，如果你不会运行项目，也不用怕的，直接让Claude Code 帮你运行项目。

![](https://cdn.xiaolincoding.com//picgo/image-20260703002248007.png)

运行成功！

![](https://cdn.xiaolincoding.com//picgo/image-20260703002345973.png)

我自己测试了这个任务看版，修改任务的负责人、拖拉拽任务都是没问题，体验起来还是很ok的，可以说是很好完成了我这次的任务。

![](https://cdn.xiaolincoding.com//picgo/20260703002453_rec_.gif)
...
![](https://cdn.xiaolincoding.com//picgo/51f9c4a3_demo-command-recap.png)
...
![](https://cdn.xiaolincoding.com//picgo/ed3ec874_speckit-clarify-questions.png)
...
![](https://cdn.xiaolincoding.com//picgo/9d31a222_speckit-analyze-checkup.png)
...
![](https://cdn.xiaolincoding.com//picgo/b1e39918_thinking-before-coding-gate.png)
...
![](https://cdn.xiaolincoding.com//picgo/a6daca57_waterfall-vs-spec-driven.png)
...
![](https://cdn.xiaolincoding.com//picgo/9cb3406f_when-to-use-spec-driven.png)
