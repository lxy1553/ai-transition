...
url: http://xiaolinnote.com/claudecode/playbook/cc_large_codebase.html
scraped: 2026-07-23T11:39:04.747602
---

# Claude Code 大型代码库实战：百万行代码怎么扛得住？

> 原文链接: http://xiaolinnote.com/claudecode/playbook/cc_large_codebase.html

# Claude Code 大型代码库实战：百万行代码怎么扛得住？

原创公众号@小林coding图解Claude Code大约 23 分钟约 6793 字

---

# [Claude Code 大型代码库实战：百万行代码怎么扛得住？](#claude-code-大型代码库实战-百万行代码怎么扛得住)
...
![](https://cdn.xiaolincoding.com//picgo/01-context-cup-tank-33dec4b6.png)
...
![](https://cdn.xiaolincoding.com//picgo/02-rag-vs-agentic-search-bc77cc7e.png)
...
![](https://cdn.xiaolincoding.com//picgo/03-agentic-search-loop-58f5857c.png)
...
![](https://cdn.xiaolincoding.com//picgo/04-harness-kitchen-c6d1d4da.png)

Anthropic 的 harness 一共七层，每层都建立在前一层基础上：**[CLAUDE.md](http://CLAUDE.md) → Hooks → Skills → Plugins → MCP**，再加两个增强 **LSP 和子 agent**。

![](https://cdn.xiaolincoding.com//picgo/6a04aaf1c37c6196e5ee19bb_fig1-the-claude-code-harness-v1%402x.png)
...
![](https://cdn.xiaolincoding.com//picgo/05-claude-md-layered-loading-ce6d4864.png)
...
![](https://cdn.xiaolincoding.com//picgo/06-claude-md-line-check-f657d9e7.png)

任何时候你发现 Claude 还在反复犯某个错，**先别急着加新规则，先去看看 [CLAUDE.md](http://CLAUDE.md) 是不是已经太长把规则淹没了**。

![](https://cdn.xiaolincoding.com//picgo/07-claude-md-pruning-1e32879c.png)
...
![](https://cdn.xiaolincoding.com//picgo/08-hook-self-evolution-47fdc06a.png)
...
![](https://cdn.xiaolincoding.com//picgo/09-lsp-vs-grep-d31d462c.png)
...
![](https://cdn.xiaolincoding.com//picgo/10-lsp-two-step-install-89d13c70.png)
...
![](https://cdn.xiaolincoding.com//picgo/11-repo-root-vs-subdir-b06f70ad.png)
...
![](https://cdn.xiaolincoding.com//picgo/12-subagent-explore-edit-5a3737f1.png)
...
![](https://cdn.xiaolincoding.com//picgo/13-session-splitting-43428cec.png)
...
![](https://cdn.xiaolincoding.com//picgo/14-batch-workflow-15528850.png)
...
![](https://cdn.xiaolincoding.com//picgo/15-skill-on-demand-3fc65073.png)
...
![](https://cdn.xiaolincoding.com//picgo/16-plugin-distribution-b16866c7.png)
...
![](https://cdn.xiaolincoding.com//picgo/17-harness-rollout-pyramid-3437ec6b.png)
...
![](https://cdn.xiaolincoding.com//picgo/18-boris-setup-fd3c2821.png)
...
![](https://cdn.xiaolincoding.com//picgo/19-claude-code-fit-table-7cfe5d5c.png)
