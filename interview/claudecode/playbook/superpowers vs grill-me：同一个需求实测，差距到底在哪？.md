...
url: http://xiaolinnote.com/claudecode/playbook/superpowers_vs_grillme.html
scraped: 2026-07-23T11:39:07.825173
---

# superpowers vs grill-me：同一个需求实测，差距到底在哪？

> 原文链接: http://xiaolinnote.com/claudecode/playbook/superpowers_vs_grillme.html

# superpowers vs grill-me：同一个需求实测，差距到底在哪？

原创公众号@小林coding图解Claude Code大约 12 分钟约 3728 字

---

# [superpowers vs grill-me：同一个需求实测，差距到底在哪？](#superpowers-vs-grill-me-同一个需求实测-差距到底在哪)
...
![](https://cdn.xiaolincoding.com//picgo/image-20260713202719396.png)
...
![](https://cdn.xiaolincoding.com//picgo/20260713210125_rec_.gif)

superpowers 交出来的长这样。

![](https://cdn.xiaolincoding.com//picgo/20260713205812_rec_.gif)
...
![](https://cdn.xiaolincoding.com//picgo/593a8617_grill-me-vs-superpowers-pipeline.png)
...
![](https://cdn.xiaolincoding.com//picgo/image-20260712221247219.png)

它的第一个动作还是老规矩，先翻家底。发现目录是空的，它说了句「全新项目，没有可以探索的代码，那我们从头把设计聊透」，然后开问。

第一问就是最上游的岔口，伪 3D 三车道，还是 2D 横版？它推荐前者，理由是「三车道左右切换是这个玩法的灵魂」。

![](https://cdn.xiaolincoding.com//picgo/image-20260712221545790.png)
...
![](https://cdn.xiaolincoding.com//picgo/image-20260713211445313.png)

唯一一次没同意，是第 9 问，美术风格。

这一问值得单独说。它给了三个选项，明快日间卡通、霓虹夜跑、像素风。它推荐霓虹夜跑，理由说得相当诚实，「坦白说这是扬长避短的选择，我们没有美术资源，全靠代码画，夜色也天然隐藏远处细节的缺失。」

![](https://cdn.xiaolincoding.com//picgo/image-20260712222449887.png)
...
![](https://cdn.xiaolincoding.com//picgo/image-20260712222930503.png)
...
![](https://cdn.xiaolincoding.com//picgo/image-20260713153346273.png)

有一点让我觉得很好笑的是，做出来的下滑操作的动作设计，有一种很滑稽的感觉。

![](https://cdn.xiaolincoding.com//picgo/image-20260713213010108.png)

撞到障碍物的时候，也会有挂掉的表情。

![](https://cdn.xiaolincoding.com//picgo/image-20260713213233549.png)
...
![](https://cdn.xiaolincoding.com//picgo/image-20260713214710526.png)
...
![](https://cdn.xiaolincoding.com//picgo/image-20260712225526548.png)

它也是先翻目录再开问，但问法完全是另一个画风。不是一行行的文字问答，是选项卡片，光标挑一个回车就行，还有多选题。

![](https://cdn.xiaolincoding.com//picgo/image-20260712225615787.png)



![](https://cdn.xiaolincoding.com//picgo/image-20260712225821976.png)
...
![](https://cdn.xiaolincoding.com//picgo/image-20260712225918217.png)
...
![](https://cdn.xiaolincoding.com//picgo/image-20260712230107632.png)
...
![](https://cdn.xiaolincoding.com//picgo/image-20260712230727739.png)

然后自动进入下一个 skill 写实施计划，10 个任务，54 项单元测试，16 项浏览器人工验证清单，每个任务都是「先写失败的测试，再写实现」的完整循环。写完问我，执行方式选哪种？我选了它推荐的子代理模式。

![](https://cdn.xiaolincoding.com//picgo/image-20260712232057128.png)
...
![](https://cdn.xiaolincoding.com//picgo/image-20260713215135795.png)

全部跑完，成品就是开头那个深蓝夜色版。下面这一张是游戏开始介绍页，相对比较简陋

![](https://cdn.xiaolincoding.com//picgo/image-20260713215607114.png)
...
![](https://cdn.xiaolincoding.com//picgo/image-20260713220435626.png)
