---
title: Claude Fable 5 系统提示词详解：1600 行泄漏 prompt 里的工程干货
url: http://xiaolinnote.com/claudecode/prompt/fable5_prompt_leak_cl4.html
scraped: 2026-07-23T11:39:08.660550
---

# Claude Fable 5 系统提示词详解：1600 行泄漏 prompt 里的工程干货

> 原文链接: http://xiaolinnote.com/claudecode/prompt/fable5_prompt_leak_cl4.html

# Claude Fable 5 系统提示词详解：1600 行泄漏 prompt 里的工程干货

原创公众号@小林coding图解Claude Code大约 25 分钟约 7393 字

---

# [Claude Fable 5 系统提示词详解：1600 行泄漏 prompt 里的工程干货](#claude-fable-5-系统提示词详解-1600-行泄漏-prompt-里的工程干货)

大家好，我是小林。

前几天有位林友给我留言，说 Claude Fable 5 提示词泄漏了，让我去看看。

![](https://cdn.xiaolincoding.com//picgo/image-20260620012955233.png)
...
![](https://cdn.xiaolincoding.com//picgo/image-20260621122624631.png)
...
## [01｜到底什么是「系统提示词」？](#_01-到底什么是「系统提示词」)
...
![](https://cdn.xiaolincoding.com//picgo/3ff5717a_user-system-prompt.png)
...
![](https://cdn.xiaolincoding.com//picgo/28898aac_prompt-size-structure.png)
...
![](https://cdn.xiaolincoding.com//picgo/0d479b09_one-prompt-vs-workbench.png)
...
## [03｜顶级 AI 手里，到底攥着哪些「家伙」？](#_03-顶级-ai-手里-到底攥着哪些「家伙」)
...
![](https://cdn.xiaolincoding.com//picgo/0fd608a2_toolbox-overview.png)
...
![](https://cdn.xiaolincoding.com//picgo/ce502a42_schema-and-manual.png)

### [第一个：教模型「什么时候该闭嘴」的 ask\_user\_input](#第一个-教模型「什么时候该闭嘴」的-ask-user-input)
...
![](https://cdn.xiaolincoding.com//picgo/c5cecd09_ask-or-answer.png)

你品品这个分寸。它防的是一个特别常见的翻车：用户明明是来要个主意的，AI 却甩一堆选项让人自己挑，看着礼貌，实则是在**用提问逃避给出观点**。

### [第二个：靠参数顺序，逼模型「先想清楚再动手」的 create\_file](#第二个-靠参数顺序-逼模型「先想清楚再动手」的-create-file)
...
![](https://cdn.xiaolincoding.com//picgo/b92a90bb_create-file-order.png)

### [第三个：给「方案」而不是给「文案」的 message\_compose](#第三个-给「方案」而不是给「文案」的-message-compose)
...
![](https://cdn.xiaolincoding.com//picgo/c342eb9f_compose-strategy.png)

### [还有一堆藏在细节里的小心机](#还有一堆藏在细节里的小心机)
...
## [04｜AI 怎么知道，啥时候该闭嘴去查一下？](#_04-ai-怎么知道-啥时候该闭嘴去查一下)
...
![](https://cdn.xiaolincoding.com//picgo/1f08665b_search-or-answer.png)
...
![](https://cdn.xiaolincoding.com//picgo/1038acf5_fetch-real-url.png)

把这套串起来你会发现，它对「知识」的态度特别清醒：**模型脑子里的东西是有保质期的**，越像「当前状态」「新玩意」的问题，越不能信自己的记忆。这份判断，对做

---

## [05｜为什么非逼模型先读说明书？](#_05-为什么非逼模型先读说明书)
...
![](https://cdn.xiaolincoding.com//picgo/e931d485_memory-hardcode-fail.png)
...
![](https://cdn.xiaolincoding.com//picgo/eb284c44_skills-first.png)
...
![](https://cdn.xiaolincoding.com//picgo/099b97eb_external-vs-internal-knowledge.png)
...
![](https://cdn.xiaolincoding.com//picgo/83c86b7e_file-vs-chat-answer.png)
...
## [06｜怎么让 AI 像人说话，还不让你上瘾？](#_06-怎么让-ai-像人说话-还不让你上瘾)
...
![](https://cdn.xiaolincoding.com//picgo/84e84f05_overformat-vs-natural.png)
...
![](https://cdn.xiaolincoding.com//picgo/45ebab33_refusal-tone.png)
...
![](https://cdn.xiaolincoding.com//picgo/8e38b536_anti-dependency.png)
...
![](https://cdn.xiaolincoding.com//picgo/74aaae05_context-care.png)
...
## [07｜安全红线，到底该怎么写？](#_07-安全红线-到底该怎么写)
...
![](https://cdn.xiaolincoding.com//picgo/5d258bc8_safety-rule-balance.png)
...
![](https://cdn.xiaolincoding.com//picgo/67635408_malicious-code-refusal.png)
...
![](https://cdn.xiaolincoding.com//picgo/29fc3b7a_principle-vs-mechanism.png)
...
![](https://cdn.xiaolincoding.com//picgo/04e180e5_reframing-danger.png)
...
![](https://cdn.xiaolincoding.com//picgo/feea19f0_final-workbench.png)
