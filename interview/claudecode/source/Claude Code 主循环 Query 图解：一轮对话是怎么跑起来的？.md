...
url: http://xiaolinnote.com/claudecode/source/cc_query_loop.html
scraped: 2026-07-23T11:39:10.701698
---

# Claude Code 主循环 Query 图解：一轮对话是怎么跑起来的？

> 原文链接: http://xiaolinnote.com/claudecode/source/cc_query_loop.html

# Claude Code 主循环 Query 图解：一轮对话是怎么跑起来的？

原创公众号@小林coding图解Claude Code大约 28 分钟约 8356 字

---

# [Claude Code 主循环 Query 图解：一轮对话是怎么跑起来的？](#claude-code-主循环-query-图解-一轮对话是怎么跑起来的)
...
![多轮循环示意图](https://cdn.xiaolincoding.com//picgo/01-multi-turn-loop-1d75cb56.png)
...
![Agent 心脏示意图](https://cdn.xiaolincoding.com//picgo/02-agent-heart-a5753eff.png)
...
![主循环代码占比柱状图](https://cdn.xiaolincoding.com//picgo/03-code-ratio-bars-f86c7446.png)
...
![四层调用链水流类比图](https://cdn.xiaolincoding.com//picgo/04-water-call-chain-08659499.png)
...
![水龙头 vs 水桶类比图](https://cdn.xiaolincoding.com//picgo/05-faucet-vs-bucket-9489bf0e.png)
...
![事件接力流水线示意图](https://cdn.xiaolincoding.com//picgo/06-event-relay-pipeline-db12e1e6.png)
...
![四层职责对照表](https://cdn.xiaolincoding.com//picgo/07-four-layer-responsibility-9189daaf.png)
...
![主循环五步流程图](https://cdn.xiaolincoding.com//picgo/25-query-loop-flowchart-03b2c3e0.png)
...
![消息历史滚雪球示意图](https://cdn.xiaolincoding.com//picgo/08-message-snowball-3d703e8f.png)
...
![文字块 vs tool_use 块对比图](https://cdn.xiaolincoding.com//picgo/09-text-vs-tool-use-0387581c.png)
...
![五步骨架环形图](https://cdn.xiaolincoding.com//picgo/10-five-step-loop-e7047e28.png)
...
![一轮迭代消息累积示意图](https://cdn.xiaolincoding.com//picgo/11-message-accumulation-160442ed.png)
...
![tool_use 决策类比图](https://cdn.xiaolincoding.com//picgo/12-bug-decision-2df754a5.png)
...
![主循环退出原因分类图](https://cdn.xiaolincoding.com//picgo/26-exit-reasons-flowchart-acb2711d.png)
...
![主循环工程量冰山图](https://cdn.xiaolincoding.com//picgo/13-engineering-iceberg-0f67c9b8.png)
...
![朴素串行 vs 流式并行时间线](https://cdn.xiaolincoding.com//picgo/14-serial-vs-streaming-94a00a86.png)
...
![点菜类比示意图](https://cdn.xiaolincoding.com//picgo/15-restaurant-ordering-c5805af3.png)
...
![最终用时对比柱状图](https://cdn.xiaolincoding.com//picgo/16-time-comparison-72c15fe5.png)
...
![只读 vs 写操作并行性对照图](https://cdn.xiaolincoding.com//picgo/17-readonly-vs-write-tools-4b3800cf.png)
...
![状态对象跨轮传递示意图](https://cdn.xiaolincoding.com//picgo/18-state-baton-loop-153dc93c.png)
...
![闭包变量 vs 状态对象对照图](https://cdn.xiaolincoding.com//picgo/19-closure-vs-state-d9039001.png)
...
![孤立 tool_use 块三种场景图](https://cdn.xiaolincoding.com//picgo/20-orphan-tool-use-causes-32135ed0.png)
...
![孤立 tool_use 补救方案图](https://cdn.xiaolincoding.com//picgo/21-fake-tool-result-repair-8d660330.png)
...
![8k 到 64k 静默升档示意图](https://cdn.xiaolincoding.com//picgo/22-8k-to-64k-upgrade-1866547d.png)
...
![max_output_tokens 两段式恢复流程图](https://cdn.xiaolincoding.com//picgo/23-max-output-recovery-055cc239.png)
...
![面试场景呼应图](https://cdn.xiaolincoding.com//picgo/24-interview-scene-d9c423cd.png)
