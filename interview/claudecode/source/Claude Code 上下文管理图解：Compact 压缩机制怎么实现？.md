...
url: http://xiaolinnote.com/claudecode/source/cc_compact.html
scraped: 2026-07-23T11:39:11.551302
---

# Claude Code 上下文管理图解：Compact 压缩机制怎么实现？

> 原文链接: http://xiaolinnote.com/claudecode/source/cc_compact.html

# Claude Code 上下文管理图解：Compact 压缩机制怎么实现？

原创公众号@小林coding图解Claude Code大约 42 分钟约 12644 字

---

# [Claude Code 上下文管理图解：Compact 压缩机制怎么实现？](#claude-code-上下文管理图解-compact-压缩机制怎么实现)

大家好，我是小林。

最近有位林友跟我说，他去面试某大厂 AI 岗，被面试官追问了不少 Claude Code 源码相关的问题。

![](https://cdn.xiaolincoding.com//picgo/image-20260702173920974.png)
...
![](https://cdn.xiaolincoding.com//picgo/b88bd6b4cbc13d45bed4fec50f4ead42.png)
...
![](https://cdn.xiaolincoding.com//picgo/01-cover-terminal-token-funnel-4dc73fe6.png)
...
![模型工作台示意图](https://cdn.xiaolincoding.com//picgo/02-context-workbench-58e1da71.png)
...
![token 消耗结构图](https://cdn.xiaolincoding.com//picgo/03-token-cost-stack-1f60d01d.png)
...
![滑动窗口示意图](https://cdn.xiaolincoding.com//picgo/04-sliding-window-cut-300c7fc1.png)
...
![每 N 轮摘要示意图](https://cdn.xiaolincoding.com//picgo/05-periodic-summary-ac775954.png)
...
![向量召回历史示意图](https://cdn.xiaolincoding.com//picgo/06-vector-recall-failures-1021bd03.png)
...
![三种方案对比示意图](https://cdn.xiaolincoding.com//picgo/07-three-methods-comparison-f30beda8.png)
...
![5 层压缩金字塔示意图](https://cdn.xiaolincoding.com//picgo/13-five-layer-pyramid-59de29a5.png)
...
![大结果存磁盘示意图](https://cdn.xiaolincoding.com//picgo/08-large-result-to-disk-09f54e21.png)
...
![Snip 砍头部示意图](https://cdn.xiaolincoding.com//picgo/09-snip-old-messages-c0310ed6.png)
...
![Micro-Compact 时间衰减示意图](https://cdn.xiaolincoding.com//picgo/10-micro-compact-decay-42a70656.png)
...
![Context Collapse 读时投影示意图](https://cdn.xiaolincoding.com//picgo/11-context-collapse-projection-bdef924f.png)
...
![Auto-Compact 全量摘要示意图](https://cdn.xiaolincoding.com//picgo/12-auto-compact-full-summary-56166f38.png)
...
![Auto-Compact 全景图](https://cdn.xiaolincoding.com//picgo/14-auto-compact-overview-4d810360.png)
...
![摘要输出长度的 p99.99 分布示意图](https://cdn.xiaolincoding.com//picgo/15-summary-p9999-distribution-d70ffa3b.png)
...
![手动 vs 自动触发对比图](https://cdn.xiaolincoding.com//picgo/16-manual-vs-auto-trigger-9875a5c9.png)
...
![circuit breaker 熔断状态机](https://cdn.xiaolincoding.com//picgo/17-circuit-breaker-state-87894d83.png)
...
![触发时机示意图](https://cdn.xiaolincoding.com//picgo/18-trigger-buffer-timeline-1248c75f.png)
...
![「直觉做法 vs Claude Code 做法」对比图](https://cdn.xiaolincoding.com//picgo/19-intuitive-vs-claude-89b8f46a.png)
...
![信息半衰期对照图](https://cdn.xiaolincoding.com//picgo/20-information-half-life-ecb2f8bf.png)
...
![microcompact 前后瘦身对比图](https://cdn.xiaolincoding.com//picgo/21-microcompact-before-after-52816746.png)
...
![文件恢复策略示意图](https://cdn.xiaolincoding.com//picgo/22-file-recovery-budget-981fb20f.png)
...
![CLAUDE.md 双通道处理示意图](https://cdn.xiaolincoding.com//picgo/23-claude-md-dual-channel-eebad749.png)
...
![压缩前后消息链对比图](https://cdn.xiaolincoding.com//picgo/24-message-chain-before-after-cb424118.png)
...
![摘要 prompt「前后包夹」示意图](https://cdn.xiaolincoding.com//picgo/25-prompt-sandwich-warning-ed055803.png)
...
![XML 输出结构示意图](https://cdn.xiaolincoding.com//picgo/26-xml-output-structure-4fa24ba1.png)

XML 输出结构示意图

这块必须包含 **9 个固定章节**：

![摘要 prompt 结构示意图](https://cdn.xiaolincoding.com//picgo/27-summary-prompt-structure-3ada95cd.png)
...
![第 6 项 vs 第 8 项对比图](https://cdn.xiaolincoding.com//picgo/28-item6-vs-item8-d463d625.png)
...
![旧消息「真丢了」示意图](https://cdn.xiaolincoding.com//picgo/29-old-messages-gone-1f61c59a.png)
...
![压缩接力流程图](https://cdn.xiaolincoding.com//picgo/30-compact-relay-pipeline-bcf2c7dd.png)
...
![面试话术四层结构卡片图](https://cdn.xiaolincoding.com//picgo/31-interview-answer-cards-a4d9da50.png)
