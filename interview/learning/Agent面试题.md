...
category: Agent面试题
count: 8
generated: 2026-07-23T15:44:23.593182

---

## 📑 目录

1. [1. LLM 和 Agent 有什么区别？](#1.-llm-和-agent-有什么区别)
2. [2. Agent 和 Workflow 有什么区别？](#2.-agent-和-workflow-有什么区别)
3. [3. Agent 有什么工作模式？](#3.-agent-有什么工作模式)
4. [4. Function Call 是什么？](#4.-function-call-是什么)
5. [5. MCP 是什么协议？](#5.-mcp-是什么协议)
6. [6. Skills 是什么？](#6.-skills-是什么)
7. [7. Function Call、MCP、Skills 有什么区别？](#7.-function-call、mcp、skills-有什么区别)
8. [8. 什么是 A2A 协议？](#8.-什么是-a2a-协议)
