...
total: 21
generated: 2026-07-24T11:49:21.121648
---
...
1. [什么是 MCP 协议，它在 AI ⼤模型系统中的作⽤是什么？](#什么是MCP协议它在AI模型系统中的作是什么)
2. [MCP 架构包含哪些核⼼组件？](#MCP架构包含哪些核组件)
3. [MCP 协议⽀持哪两种模式？](#MCP协议持哪两种模式)
4. [MCP 的⼯作流程是什么？](#MCP的作流程是什么)
5. [在 Spring AI 框架中如何集成 MCP？](#在SpringAI框架中如何集成MCP)
6. [MCP 协议安全性设计包含哪些层⾯？](#MCP协议安全性设计包含哪些层)
7. [如何将已有的应⽤转换成 MCP 服务？](#如何将已有的应转换成MCP服务)
8. [什么是 Google ADK？](#什么是GoogleADK)
9. [什么是 Function Calling ？原理是什么？](#什么是FunctionCalling原理是什么)
10. [MCP 和 Agent Skill 的区别是什么？](#MCP和AgentSkill的区别是什么)
11. [什么是 A2A 协议？它和 MCP 协议的区别是什么？](#什么是A2A协议它和MCP协议的区别是什么)
12. [MCP 协议通常采用什么通信方式？](#MCP协议通常采用什么通信方式)
13. [说说 WebSocket 和 SSE 通信的区别及局限性？](#说说WebSocket和SSE通信的区别及局限性)
14. [为什么要用 WebRTC 协议？它和 WebSocket（WS）在 AI 对话流中的核心差异是什么？](#为什么要用WebRTC协议它和WebSocketWS在AI对话流中的核心差异是什么)
15. [有没有用过大模型的网关框架？网关层解决了什么问题？](#有没有用过大模型的网关框架网关层解决了什么问题)
16. [LLM 是如何学会调用外部工具的？](#LLM是如何学会调用外部工具的)
17. [什么是 MCP（模型上下文协议）？讲讲它的核心内容？](#什么是MCP模型上下文协议讲讲它的核心内容)
18. [MCP 由哪几部分组成？](#MCP由哪几部分组成)
19. [Function Calling 也属于工具调用，请问什么场景下使用 Function Calling，什么场景下使用 MCP？](#FunctionCalling也属于工具调用请问什么场景下使用FunctionCalling什么场景下使用MCP)
20. [为什么有些特定的推理模型不支持 MCP 协议？](#为什么有些特定的推理模型不支持MCP协议)
21. [Skill 是什么？](#Skill是什么)
