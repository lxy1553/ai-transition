...
14. [为什么要用 WebRTC 协议？它和 WebSocket（WS）在 AI 对话流中的核心差异是什么？](#为什么要用WebRTC协议它和WebSocketWS在AI对话流)
...
19. [Function Calling 也属于工具调用，请问什么场景下使用 Function Calling，什么场景下使用 MCP？](#FunctionCalling也属于工具调用请问什么场景下使用Funct)
