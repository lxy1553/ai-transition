...
category: Agent
count: 16
generated: 2026-07-23T15:44:23.589265

---

## 📑 目录

1. [1. 什么是 Agent？与大模型有什么本质不同？](#1.-什么是-agent与大模型有什么本质不同)
2. [10. 什么是 Multi-Agent？](#10.-什么是-multi-agent)
3. [11. 说说 Single-Agent 和 Multi-Agent 的设计方案？](#11.-说说-single-agent-和-multi-agent-的设计方案)
4. [12. Agent 记忆压缩通常有哪些方法？](#12.-agent-记忆压缩通常有哪些方法)
5. [13. 在工程实践中，为什么有时候选择「手搓」Agent，而不是直接用成熟框架？](#13.-在工程实践中为什么有时候选择「手搓」agent而不是直接用成熟框架)
6. [14. 如何赋予 LLM 规划能力？](#14.-如何赋予-llm-规划能力)
7. [15. 讲讲 Agent 的反思机制？为什么要用反思？具体怎么实现？](#15.-讲讲-agent-的反思机制为什么要用反思具体怎么实现)
8. [16. 如何设计多 Agent 的协作与动态切换机制？](#16.-如何设计多-agent-的协作与动态切换机制)
9. [2. Agent 的基本架构由哪些核心组件构成？](#2.-agent-的基本架构由哪些核心组件构成)
10. [3. Workflow，Agent，Tools 这三个的概念和区别介绍一下？](#3.-workflowagenttools-这三个的概念和区别介绍一下)
11. [4. 了解哪些其他的 Agent 设计范式？Agent 和 Workflow的区别是什么？](#4.-了解哪些其他的-agent-设计范式agent-和-workflow的区别是什么)
12. [5. Agent 推理模式有哪些？ReAct 是啥？具体是怎么实现的？](#5.-agent-推理模式有哪些react-是啥具体是怎么实现的)
13. [6. ReAct、Plan-and-Execute、Reflection 三种范式有什么核心区别？实际项目中该如何选型？](#6.-react、plan-and-execute、reflection-三种范式有什么核心区别实际项目中该如何选型)
14. [7. 复杂任务怎么做的任务拆分？为什么要拆分？效果如何提升？](#7.-复杂任务怎么做的任务拆分为什么要拆分效果如何提升)
15. [8. 请你介绍一下 AI Agent 的记忆机制，并说明在实际开发中应该如何设计记忆模块？](#8.-请你介绍一下-ai-agent-的记忆机制并说明在实际开发中应该如何设计记忆模块)
16. [9. Agent 的长短期记忆系统怎么做的？记忆是怎么存的？粒度是多少？怎么用的？](#9.-agent-的长短期记忆系统怎么做的记忆是怎么存的粒度是多少怎么用的)
