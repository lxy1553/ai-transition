...
category: RAG 检索增强
count: 20
generated: 2026-07-23T15:44:23.591519

---

## 📑 目录

1. [1. 什么是 RAG？详细描述一个完整 RAG 系统的详细工作流程？](#1.-什么是-rag详细描述一个完整-rag-系统的详细工作流程)
2. [10. 你使用 RAG 给大模型一个输入，系统是怎样的工作流程？](#10.-你使用-rag-给大模型一个输入系统是怎样的工作流程)
3. [11. 请你介绍一下向量检索和关键词检索的区别？](#11.-请你介绍一下向量检索和关键词检索的区别)
4. [12. 如何润色用户的 Query（Query Rewrite）？目的是什么？](#12.-如何润色用户的-query（query-rewrite）目的是什么)
5. [13. 什么是多路召回？具体怎么做？](#13.-什么是多路召回具体怎么做)
6. [14. RAG 检索优化策略有哪些？](#14.-rag-检索优化策略有哪些)
7. [15. 了解哪些更复杂的 RAG 范式？](#15.-了解哪些更复杂的-rag-范式)
8. [16. 在什么场景下，你会选择使用图数据库来增强传统的向量检索？](#16.-在什么场景下你会选择使用图数据库来增强传统的向量检索)
9. [17. 如何规避 RAG 系统中大模型的幻觉？](#17.-如何规避-rag-系统中大模型的幻觉)
10. [18. 怎么量化你的 RAG 效果？](#18.-怎么量化你的-rag-效果)
11. [19. RAG 知识库如何实现动态与持续更新？](#19.-rag-知识库如何实现动态与持续更新)
12. [2. 大模型的 RAG 主要用来解决什么问题？](#2.-大模型的-rag-主要用来解决什么问题)
13. [20. 在实际落地中，你觉得 RAG 最难的地方是哪里？](#20.-在实际落地中你觉得-rag-最难的地方是哪里)
14. [3. 相比直接微调 LLM，RAG 解决了什么问题？微调和 RAG 各自的优劣势是什么？](#3.-相比直接微调-llmrag-解决了什么问题微调和-rag-各自的优劣势是什么)
15. [4. RAG 中的文档是怎么存的？粒度是多大？详细说说文档切割（Chunking）策略？](#4.-rag-中的文档是怎么存的粒度是多大详细说说文档切割（chunking）策略)
16. [5. 怎么规避语义被切割掉的问题？](#5.-怎么规避语义被切割掉的问题)
17. [6. 在 RAG 中 Embedding 究竟是什么？如何选择和评估一个 Embedding 模型？](#6.-在-rag-中-embedding-究竟是什么如何选择和评估一个-embedding-模型)
18. [7. Embedding 有哪几种算法你了解过吗？](#7.-embedding-有哪几种算法你了解过吗)
19. [8. 什么是向量数据库？有没有做过向量数据库的对比选型？](#8.-什么是向量数据库有没有做过向量数据库的对比选型)
20. [9. 讲讲你用的向量数据库？数据量级是多大？性能如何？遇到过性能瓶颈吗？](#9.-讲讲你用的向量数据库数据量级是多大性能如何遇到过性能瓶颈吗)
