...
## 1. 1. 什么是 Function Calling ？原理是什么？
...
## 3. 11. Function Calling、Skill、MCP 这三个有什么区别？
...
## 4. 12. 什么是 A2A 协议？它和 MCP 协议的区别是什么？
...
## 6. 14. 说说 WebSocket 和 SSE 通信的区别及局限性？
...
## 7. 15. 为什么要用 WebRTC 协议？它和 WebSocket（WS）在 AI 对话流中的核心差异是什么？
...
## 10. 3. 大模型的 Function Call 能力是怎么训练出来的？
...
## 13. 6. MCP 和 Function Calling 有什么区别？有没有实际跑过 MCP？
...
## 14. 7. Function Calling 也属于工具调用，请问什么场景下使用 Function Calling，什么场景下使用 MCP？
