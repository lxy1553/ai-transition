y# 面试官：“Agent 不就是 LLM 加点工具？”，我：“ReAct、MCP、Skills、Function Call、A2A ……”
...
Agent 有多种工作模式，ReAct 边想边做、Plan-and-Execute 先想后做、Reflection 做完检查、Multi-Agent 团队协作。
在底层技术上：
...
✅AI全栈私教：AI全栈开发1v1私教辅导
✅AI项目：智能OnCall Agent项目
✅AI项目：MewCode Agent项目