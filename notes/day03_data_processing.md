...
生产里数据处理不能只追求能读入文件，还要做字段校验、异常值处理、去重、标准化和质量记录。
...
### 6. [Day 1] 为什么转 AI 应用方向前，要先明确目标岗位和能力差距？
  我的回答：

### 7. [Day 1] 数据仓库背景转 AI 应用方向，最能迁移的能力是什么？
  我的回答：

### 8. [Day 2] 为什么项目代码要拆成模块，而不是全部写在一个文件里？
  我的回答：

### 9. [Day 2] Python 基础能力如何支撑后面的 API、RAG 和 NL2SQL 项目？
  我的回答：
