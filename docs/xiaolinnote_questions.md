...
## [LLM 和 Agent 有什么区别？](#llm-和-agent-有什么区别)
...
### [Agent 怎么解决 LLM 的弊端？](#agent-怎么解决-llm-的弊端)
...
### [什么时候用 Workflow，什么时候用 Agent？](#什么时候用-workflow-什么时候用-agent)
...
### [模式二：Plan-and-Execute（先想好再做）](#模式二-plan-and-execute-先想好再做)
...
### [模式三：Reflection（做完再检查）](#模式三-reflection-做完再检查)
...
### [模式四：Multi-Agent（团队协作）](#模式四-multi-agent-团队协作)
...
### [Function Call 的工作原理](#function-call-的工作原理)
...
### [为什么 Function Call 这么重要？](#为什么-function-call-这么重要)
...
### [Function Call 和 Agent 的关系](#function-call-和-agent-的关系)
...
### [Function Call 的集成困境](#function-call-的集成困境)
...
## [Function Call、MCP、Skills 有什么区别？](#function-call、mcp、skills-有什么区别)
...
### [A2A 和 MCP 是什么关系？](#a2a-和-mcp-是什么关系)
...
### X002
**分类：** Agent图解专栏
**题目：** OpenClaw 是什么？OpenClaw 面试题万字图解
**参考答案：** 大家好，我是小林。
...
## [1、什么是 OpenClaw？](#_1、什么是-openclaw)
...
## [2、OpenClaw 核心亮点是什么？](#_2、openclaw-核心亮点是什么)
...
## [3、OpenClaw 文件目录结构是怎样的？](#_3、openclaw-文件目录结构是怎样的)
...
## [4、OpenClaw 与传统的 Agent 有什么区别？](#_4、openclaw-与传统的-agent-有什么区别)
...
## [5、OpenClaw 的记忆化机制是怎么实现的？](#_5、openclaw-的记忆化机制是怎么实现的)
...
## [6、OpenClaw 到底解决了什么痛点？](#_6、openclaw-到底解决了什么痛点)
...
## [7、OpenClaw 有什么缺点？](#_7、openclaw-有什么缺点)
...
## [8、Coze、n8n 和 OpenClaw 的区别在哪里？](#_8、coze、n8n-和-openclaw-的区别在哪里)
...
## [9. 为什么 OpenClaw 那么烧 token？](#_9-为什么-openclaw-那么烧-token)
...
### [第一阶段：Prompt Engineering，先让模型「听懂」你](#第一阶段-prompt-engineering-先让模型「听懂」你)
...
### [第二阶段：Context Engineering，让模型「知道」该用什么信息](#第二阶段-context-engineering-让模型「知道」该用什么信息)
...
### [第三阶段：Harness Engineering，让模型「做对」一连串的事](#第三阶段-harness-engineering-让模型「做对」一连串的事)
...
## [Harness 拆开看，里面到底装了些啥？](#harness-拆开看-里面到底装了些啥)
...
### [第六层，约束校验与失败恢复机制](#第六层-约束校验与失败恢复机制)
...
### [难题一，Agent 跑久了为啥会越走越偏？](#难题一-agent-跑久了为啥会越走越偏)
...
### [难题二，让 Agent 自己给自己打分，为啥总偏乐观？](#难题二-让-agent-自己给自己打分-为啥总偏乐观)
...
### [难题三，Agent 总是失败，工程师到底该干啥？](#难题三-agent-总是失败-工程师到底该干啥)
...
### [难题四，规范文件越写越长，为啥 Agent 反而更糊涂？](#难题四-规范文件越写越长-为啥-agent-反而更糊涂)
...
### [难题五，Agent 写的代码越堆越烂，技术债怎么还？](#难题五-agent-写的代码越堆越烂-技术债怎么还)
...
### [顺便提一个反直觉的发现：Agent 用「老技术」反而更稳](#顺便提一个反直觉的发现-agent-用「老技术」反而更稳)
...
### X008
**分类：** Agent
**题目：** 1. 什么是 Agent？与大模型有什么本质不同？
**参考答案：** 👔面试官：说说你理解的 AI Agent 是什么？
...
### X009
**分类：** Agent
**题目：** 10. 什么是 Multi-Agent？
**参考答案：** 👔面试官：你了解 Multi-Agent 吗，说说它是什么，为什么要用？
...
### X010
**分类：** Agent
**题目：** 11. 说说 Single-Agent 和 Multi-Agent 的设计方案？
**参考答案：** 👔面试官：你实际项目里是怎么做技术选型的，什么时候用 Single-Agent，什么时候上 Multi-Agent？
...
### X011
**分类：** Agent
**题目：** 12. Agent 记忆压缩通常有哪些方法？
**参考答案：** 👔面试官：你项目里 Agent 对话历史越来越长，context 快撑满了怎么办？有没有做记忆压缩？
...
### X012
**分类：** Agent
**题目：** 13. 在工程实践中，为什么有时候选择「手搓」Agent，而不是直接用成熟框架？
**参考答案：** 👔面试官：你平时做 Agent 开发用什么框架？
...
### X014
**分类：** Agent
**题目：** 15. 讲讲 Agent 的反思机制？为什么要用反思？具体怎么实现？
**参考答案：** 👔面试官：Agent 的反思机制你了解吗？怎么实现的？
...
### X015
**分类：** Agent
**题目：** 16. 如何设计多 Agent 的协作与动态切换机制？
**参考答案：** 👔面试官：多 Agent 系统里，各个 Agent 之间怎么协作？
...
### X016
**分类：** Agent
**题目：** 2. Agent 的基本架构由哪些核心组件构成？
**参考答案：** 👔面试官：Agent 架构里有哪些核心组件？
...
### X017
**分类：** Agent
**题目：** 3. Workflow，Agent，Tools 这三个的概念和区别介绍一下？
**参考答案：** 👔面试官：Workflow、Agent、Tools 这三个概念说一下，区别是什么？
...
### X018
**分类：** Agent
**题目：** 4. 了解哪些其他的 Agent 设计范式？Agent 和 Workflow的区别是什么？
**参考答案：** 👔面试官：你了解哪些 Agent 的设计范式？
...
### X019
**分类：** Agent
**题目：** 5. Agent 推理模式有哪些？ReAct 是啥？具体是怎么实现的？
**参考答案：** 👔面试官：你做过 Agent 项目，那你说说 ReAct 是什么，跟普通的 LLM 调用有什么区别？
...
### X020
**分类：** Agent
**题目：** 6. ReAct、Plan-and-Execute、Reflection 三种范式有什么核心区别？实际项目中该如何选型？
**参考答案：** 👔面试官：你来说说 ReAct、Plan-and-Execute、Reflection 三种范式的区别？
...
### X021
**分类：** Agent
**题目：** 7. 复杂任务怎么做的任务拆分？为什么要拆分？效果如何提升？
**参考答案：** 👔面试官：你说说任务拆分是怎么做的，为什么要拆分，有什么实际收益？
...
### X022
**分类：** Agent
**题目：** 8. 请你介绍一下 AI Agent 的记忆机制，并说明在实际开发中应该如何设计记忆模块？
**参考答案：** 👔面试官：你来讲讲 Agent 的记忆机制，分哪几种，各自有什么作用？
...
### X023
**分类：** Agent
**题目：** 9. Agent 的长短期记忆系统怎么做的？记忆是怎么存的？粒度是多少？怎么用的？
**参考答案：** 👔面试官：你们项目里 Agent 的记忆系统是怎么做的，短期记忆和长期记忆分别存在哪？
...
### X024
**分类：** 大模型工程
**题目：** 1. 什么是大语言模型？和传统 NLP 模型有什么区别？
**参考答案：** 👔面试官：来，讲讲什么是大语言模型？它和我们以前用的传统 NLP 模型有什么区别？
...
### X025
**分类：** 大模型工程
**题目：** 10. SFT 之后还有哪些 Post-Training？RLHF、DPO、GRPO、拒绝采样什么关系？
**参考答案：** 👔面试官：来讲讲 SFT 之后还有哪些 Post-Training 方法？RLHF、DPO、GRPO、拒绝采样这几个什么关系？
...
### X026
**分类：** 大模型工程
**题目：** 11. 大模型的 DPO 和 PPO 的区别是什么？
**参考答案：** 👔面试官：来讲讲大模型的 DPO 和 PPO 有什么区别？
...
### X027
**分类：** 大模型工程
**题目：** 12. 大模型生成文本时的解码策略有哪些？贪心、Beam Search、采样分别什么时候用？
**参考答案：** 👔面试官：来讲讲大模型生成文本时的解码策略有哪些？贪心、Beam Search、采样这几种各自在什么场景用？
...
### X028
**分类：** 大模型工程
**题目：** 13. 大模型的参数：温度值、Top-P、Top-K 分别是什么？各个场景下的最佳设置是什么？
**参考答案：** 👔面试官：来讲讲大模型的几个采样参数：温度值、Top-P、Top-K 分别是什么？各场景下怎么设置？
...
### X029
**分类：** 大模型工程
**题目：** 14. KV Cache 是什么？Prompt Caching 的原理是什么？
**参考答案：** 👔面试官：来讲讲什么是 KV Cache？Prompt Caching 又是怎么回事？这两个有什么关系？
...
### X030
**分类：** 大模型工程
**题目：** 15. 大模型量化是什么？INT8/INT4/AWQ/GPTQ 怎么选？
**参考答案：** 👔面试官：来讲讲什么是大模型量化？INT8、INT4、AWQ、GPTQ 这些方案怎么选？
...
### X031
**分类：** 大模型工程
**题目：** 16. 如何写好 Prompt？分享下 Prompt 工程实践经验？
**参考答案：** 👔面试官：来讲讲怎么写好 Prompt？分享下 Prompt 工程的实践经验？
...
### X032
**分类：** 大模型工程
**题目：** 17. 什么是 CoT？为啥效果好？它有什么缺点或局限性？
**参考答案：** 👔面试官：来讲讲什么是 CoT？为啥效果好？它有什么缺点或局限性？
...
### X033
**分类：** 大模型工程
**题目：** 18. 大模型为什么会出现幻觉？怎么缓解？
**参考答案：** 👔面试官：来讲讲大模型为什么会出现幻觉？怎么缓解？
...
### X034
**分类：** 大模型工程
**题目：** 19. MoE 混合专家模型是什么？DeepSeek V3、Qwen 为什么用 MoE？
**参考答案：** 👔面试官：来讲讲什么是 MoE 混合专家模型？为什么 DeepSeek V3、Qwen 这些主流大模型现在都在用 MoE？
...
### X035
**分类：** 大模型工程
**题目：** 2. 讲讲 Transformer 架构基本原理？Encoder 和 Decoder 是什么？
**参考答案：** 👔面试官：来讲讲 Transformer 架构的基本原理？Encoder 和 Decoder 是什么？
...
### X036
**分类：** 大模型工程
**题目：** 20. 大模型部署有哪些主流方案？vLLM、TGI、llama.cpp、SGLang 实际项目里怎么选？
**参考答案：** 👔面试官：来讲讲大模型部署有哪些主流方案？vLLM、TGI、llama.cpp、SGLang 这几个怎么选？
...
### X038
**分类：** 大模型工程
**题目：** 22. 对比使用过哪些主流大模型？你们项目中最终选用了哪个模型？为什么？
**参考答案：** 👔面试官：来讲讲你对比过哪些主流大模型？项目里最终选了哪个？为什么？
...
### X039
**分类：** 大模型工程
**题目：** 3. 多头注意力（MHA）有哪些局限？MQA、GQA、Flash Attention 怎么解决？
**参考答案：** 👔面试官：来讲讲多头注意力（MHA）有哪些局限？工业界怎么优化？
...
### X040
**分类：** 大模型工程
**题目：** 4. 大模型的位置编码是干什么用的？sin/cos、RoPE、ALiBi 有什么区别？
**参考答案：** 👔面试官：来讲讲大模型为什么需要位置编码？sin/cos、RoPE、ALiBi 这几种各有什么区别？
...
### X041
**分类：** 大模型工程
**题目：** 5. 什么是大模型项目的分词器？原理是什么？
**参考答案：** 👔面试官：来讲讲什么是大模型项目的分词器？原理是什么？
...
### X043
**分类：** 大模型工程
**题目：** 7. 什么是 Scaling Law？大模型的「涌现能力」是怎么回事？
**参考答案：** 👔面试官：来讲讲什么是 Scaling Law？大模型的「涌现能力」是怎么回事？
...
### X045
**分类：** 大模型工程
**题目：** 9. 请讲一下 LoRA 技术，除了减少参数量，它还有哪些优点？
**参考答案：** 👔面试官：来讲一下 LoRA 技术，除了减少参数量，它还有哪些优点？
...
### X046
**分类：** RAG 检索增强
**题目：** 1. 什么是 RAG？详细描述一个完整 RAG 系统的详细工作流程？
**参考答案：** 👔面试官：来说说什么是 RAG？详细描述一下一个完整 RAG 系统的工作流程。
...
### X047
**分类：** RAG 检索增强
**题目：** 10. 你使用 RAG 给大模型一个输入，系统是怎样的工作流程？
**参考答案：** 👔面试官：当你给 RAG 系统输入一个问题，整个系统的工作流程是怎样的？从用户提问到最终拿到答案，中间经历了哪些步骤？
...
### X048
**分类：** RAG 检索增强
**题目：** 11. 请你介绍一下向量检索和关键词检索的区别？
**参考答案：** 👔面试官：请你介绍一下向量检索和关键词检索的区别？
...
### X049
**分类：** RAG 检索增强
**题目：** 12. 如何润色用户的 Query（Query Rewrite）？目的是什么？
**参考答案：** 👔面试官：RAG 系统里为什么要做 Query Rewrite？你了解哪些方法？
...
**分类：** RAG 检索增强
**题目：** 14. RAG 检索优化策略有哪些？
**参考答案：** 👔面试官：RAG 系统的检索效果不好，你会从哪些方面优化？
...
### X052
**分类：** RAG 检索增强
**题目：** 15. 了解哪些更复杂的 RAG 范式？
**参考答案：** 👔面试官：你了解哪些更复杂的 RAG 范式？除了最基本的检索加生成，还有什么更高级的玩法？
...
### X053
**分类：** RAG 检索增强
**题目：** 16. 在什么场景下，你会选择使用图数据库来增强传统的向量检索？
**参考答案：** 👔面试官：在什么场景下，你会选择使用图数据库来增强传统的向量检索？
...
### X054
**分类：** RAG 检索增强
**题目：** 17. 如何规避 RAG 系统中大模型的幻觉？
**参考答案：** 👔面试官：RAG 系统中大模型的幻觉问题你怎么处理？
...
**分类：** RAG 检索增强
**题目：** 18. 怎么量化你的 RAG 效果？
**参考答案：** 👔面试官：你们线上跑了 RAG，那你怎么衡量它的效果好不好？
...
### X056
**分类：** RAG 检索增强
**题目：** 19. RAG 知识库如何实现动态与持续更新？
**参考答案：** 👔面试官：你们 RAG 知识库上线之后，文档更新了怎么办？总不能每次改个文档就把整个知识库重建一遍吧。
...
### X057
**分类：** RAG 检索增强
**题目：** 2. 大模型的 RAG 主要用来解决什么问题？
**参考答案：** 👔面试官：你说你做过 RAG 项目，那 RAG 主要用来解决什么问题？
...
### X058
**分类：** RAG 检索增强
**题目：** 20. 在实际落地中，你觉得 RAG 最难的地方是哪里？
**参考答案：** 👔面试官：RAG 你也做了一段时间了，你觉得实际落地中最难的地方在哪？
...
### X059
**分类：** RAG 检索增强
**题目：** 3. 相比直接微调 LLM，RAG 解决了什么问题？微调和 RAG 各自的优劣势是什么？
**参考答案：** 👔面试官：RAG 和微调（Fine-tuning）有什么区别？各自适合什么场景？
...
### X060
**分类：** RAG 检索增强
**题目：** 4. RAG 中的文档是怎么存的？粒度是多大？详细说说文档切割（Chunking）策略？
**参考答案：** 👔面试官：RAG 里的文档是怎么存进向量库的？你说说 Chunking 怎么做。
...
**分类：** RAG 检索增强
**题目：** 5. 怎么规避语义被切割掉的问题？
**参考答案：** 👔面试官：Chunking 的时候语义被切断是个很常见的问题，你有没有遇到过？怎么处理的？
...
### X062
**分类：** RAG 检索增强
**题目：** 6. 在 RAG 中 Embedding 究竟是什么？如何选择和评估一个 Embedding 模型？
**参考答案：** 👔面试官：RAG 里的 Embedding 是什么？你是怎么选模型的？
...
### X063
**分类：** RAG 检索增强
**题目：** 7. Embedding 有哪几种算法你了解过吗？
**参考答案：** 👔面试官：RAG 里用的 Embedding 算法有哪些？你了解过几代演进？
...
### X064
**分类：** RAG 检索增强
**题目：** 8. 什么是向量数据库？有没有做过向量数据库的对比选型？
**参考答案：** 👔面试官：来说说什么是向量数据库？你有没有做过向量数据库的对比选型？
...
### X065
**分类：** RAG 检索增强
**题目：** 9. 讲讲你用的向量数据库？数据量级是多大？性能如何？遇到过性能瓶颈吗？
**参考答案：** 👔面试官：你在项目里用的什么向量数据库？数据量级大概多少？
...
### X066
**分类：** LLM工具调用与协议
**题目：** 1. 什么是 Function Calling ？原理是什么？
**参考答案：** 👔面试官：来聊聊 Function Calling 吧，说说它是什么、原理是怎样的？
...
### X067
**分类：** LLM工具调用与协议
**题目：** 10. MCP 和 Agent Skill 的区别是什么？
**参考答案：** 👔面试官：MCP 和 Agent Skill 有什么区别？
...
### X068
**分类：** LLM工具调用与协议
**题目：** 11. Function Calling、Skill、MCP 这三个有什么区别？
**参考答案：** 👔面试官：Function Calling、Skill、MCP 这三个概念有什么区别？
...
### X069
**分类：** LLM工具调用与协议
**题目：** 12. 什么是 A2A 协议？它和 MCP 协议的区别是什么？
**参考答案：** 👔面试官：说说什么是 A2A 协议，它和 MCP 有什么区别？
...
### X070
**分类：** LLM工具调用与协议
**题目：** 13. MCP 协议通常采用什么通信方式？
**参考答案：** 👔面试官：MCP 协议通常采用什么通信方式？
...
### X071
**分类：** LLM工具调用与协议
**题目：** 14. 说说 WebSocket 和 SSE 通信的区别及局限性？
**参考答案：** 👔面试官：说说 WebSocket 和 SSE 通信的区别及局限性？
...
### X072
**分类：** LLM工具调用与协议
**题目：** 15. 为什么要用 WebRTC 协议？它和 WebSocket（WS）在 AI 对话流中的核心差异是什么？
**参考答案：** 👔面试官：为什么 AI 实时语音要用 WebRTC？它和 WebSocket 在 AI 对话流中的核心差异是什么？
...
### X073
**分类：** LLM工具调用与协议
**题目：** 16. 有没有用过大模型的网关框架？网关层解决了什么问题？
**参考答案：** 👔面试官：有没有用过大模型的网关框架？网关层主要解决什么问题？
...
### X074
**分类：** LLM工具调用与协议
**题目：** 2. LLM 是如何学会调用外部工具的？
**参考答案：** 👔面试官：说说大模型是怎么学会调用外部工具的？
...
### X075
**分类：** LLM工具调用与协议
**题目：** 3. 大模型的 Function Call 能力是怎么训练出来的？
**参考答案：** 👔面试官：详细说说大模型的 Function Call 能力是怎么训练出来的？
...
### X076
**分类：** LLM工具调用与协议
**题目：** 4. 什么是 MCP（模型上下文协议）？讲讲它的核心内容？
**参考答案：** 👔面试官：说说什么是 MCP？它的核心内容是什么？
...
### X078
**分类：** LLM工具调用与协议
**题目：** 6. MCP 和 Function Calling 有什么区别？有没有实际跑过 MCP？
**参考答案：** 👔面试官：来聊聊 MCP 和 Function Calling 的区别吧。
...
### X079
**分类：** LLM工具调用与协议
**题目：** 7. Function Calling 也属于工具调用，请问什么场景下使用 Function Calling，什么场景下使用 MCP？
**参考答案：** 👔面试官：Function Calling 和 MCP 都能做工具调用，那具体什么场景下该选哪个？
...
### X080
**分类：** LLM工具调用与协议
**题目：** 8. 为什么有些特定的推理模型不支持 MCP 协议？
**参考答案：** 👔面试官：为什么有些推理模型不支持 MCP 协议？
...
### X097
**分类：** Claude Code图解专栏
**题目：** Claude Code 记忆机制图解：为什么不用向量数据库？
**参考答案：** 大家好，我是小林。
